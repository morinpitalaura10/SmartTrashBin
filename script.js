document.addEventListener('DOMContentLoaded', () => {
    ...
    <div class="cards">
        ...
        <div class="card">
        <i class="fa-solid fa-trash-arrow-turn-up icon"></i>
        <div>
        ...
        <div class="card">
        <i class="fa-solid fa-trash-can-arrow-down icon"></i>
        <div>
    ...
    <div class="table-container">
        ...
        <thead>
            <tr>
            <th>ID</th><th>Nama</th><th>Lantai</th><th>Lokasi</th><th>Kapasitas</th><th>Status</th><th>Aksi</th>
            </tr>
        </thead>
        <tbody>
